            ...
            <section className='fundo-cartao'>
                <div className='div-cartao'>
                    <div className='produtos'>
                        <Pesquisa imagem='/images/produto11.png' nome='Bermuda Nike Masculino' preco='R$ 100,00' />
                    ...
                    <div className='produtos'>
                        ...
                        <Pesquisa imagem='/images/produto17.png' nome='Camiseta Street Maculino' preco='R$ 140,00' />
                        <Pesquisa imagem='/images/produto18.png' nome='Bermuda Street Masculino' preco='R$ 119,00' />
                        <Pesquisa imagem='/images/produto19.png' nome='Camiseta Street Masculino' preco='R$ 140,00' />
