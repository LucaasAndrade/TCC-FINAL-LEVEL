        ...
        <div className='componente-avaliacao'>
            ...
            <div className='gostou-avaliacao'>
                ...
                <div className='gostou'>
                    ...
                    <span> {props.item.mais} 0 </span>
                </div>
                <div className='gostou'>
                    <img className='gost' src='/images/nao-gostei.png'></img>
                    <span> {props.item.menos} 0 </span>
                </div>
            </div>
        </div>
    )
